...
Также применим шардирование у комментариев, для ускорения записи. Так как 
мы комментируем всегда какой либо пост, можно шардировать комменты по числу лайков у поста.
