...
PostgreSql будет использоваться для поиска id всез друзей, на которых подписан пользователь, а затем мы запросим у Redis
...
| ----------------- | ------------------| ------- | ------- | ----------- | -------------------------------|         
| Балансировщик + Front|Intel E5-2620 v4 – 8 ядер |   64    |    2 * 1 |     -    |     28  |
| backend            |Intel E5-2660 v4 – 14 ядер  |   64    |    1    |      1      |      35  |
| service(C++)  |    Intel E5-2620 v4 – 8 ядер    |   64    |    1    |      -      |       10 |
